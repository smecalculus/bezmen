...
abstract class SepulkaClientIT {
    ...
    fun shouldRegisterSepulka() {
        ...
        // and
        val request = MessageEmEg.registrationRequest(externalId)
        // and
        whenever(serviceMock.register(any(MessageDm.RegistrationRequest::class.java)))
            .thenReturn(MessageDmEg.registrationResponse(externalId).build())
        // and
        val expectedResponse = MessageEmEg.registrationResponse(externalId)
        // when
